...
namespace MyFirstMAMVCDemo.Models
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,StudentName1,StudentDOB,Gender,IsPass,Course,Salary")] tblStudent tblStudent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,StudentName1,StudentDOB,Gender,IsPass,Course,Salary")] tblStudent tblStudent)
        {
            if (ModelState.IsValid)
            {
